...
CREATE TABLE spauth (
	...
	scms_v2_apikey VARCHAR(120) NULL DEFAULT NULL COLLATE utf8_ci,
...
COMMENT ON COLUMN spauth.scms_v2_apikey        IS 'scms v2 api key';
...
| `scms_v2_apikey` | VARCHAR(120) | NULL | scms v2 api 키 |
